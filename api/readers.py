...
async def make_reader(reader: Reader):
...
@router.put("/{id}")
async def modify_reader(id: str, reader: Reader):
    try:
...
@router.delete("/{id}")
async def remove_reader(id: str):
...
async def add_book_to_list(reader_id: str, book_id: str, list_name: str):
    """
